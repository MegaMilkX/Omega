...
void GLEXTLoadFunctions()
{
    ...
    GLPROCLOAD(PFNGLCOMPRESSEDTEXIMAGE2DPROC,   glCompressedTexImage2D);
    ...
    GLPROCLOAD2(PFNGLBINDFRAMEBUFFERPROC, glBindFramebuffer, glBindFramebuffer_);
    ...
    GLPROCLOAD(PFNGLDELETEQUERIESPROC, glDeleteQueries);
    GLPROCLOAD(PFNGLGENQUERIESPROC, glGenQueries);
    GLPROCLOAD(PFNGLBEGINQUERYPROC, glBeginQuery);
    GLPROCLOAD(PFNGLENDQUERYPROC, glEndQuery);
    GLPROCLOAD(PFNGLQUERYCOUNTERPROC, glQueryCounter);
    GLPROCLOAD(PFNGLGETQUERYOBJECTIVPROC, glGetQueryObjectiv);
    GLPROCLOAD(PFNGLGETQUERYOBJECTUIVPROC, glGetQueryObjectuiv);
    GLPROCLOAD(PFNGLGETQUERYOBJECTI64VPROC, glGetQueryObjecti64v);
    GLPROCLOAD(PFNGLGETQUERYOBJECTUI64VPROC, glGetQueryObjectui64v);
    GLPROCLOAD(PFNGLGETQUERYBUFFEROBJECTIVPROC, glGetQueryBufferObjectiv);
    GLPROCLOAD(PFNGLGETQUERYBUFFEROBJECTUIVPROC, glGetQueryBufferObjectuiv);
    GLPROCLOAD(PFNGLGETQUERYBUFFEROBJECTI64VPROC, glGetQueryBufferObjecti64v);
    GLPROCLOAD(PFNGLGETQUERYBUFFEROBJECTUI64VPROC, glGetQueryBufferObjectui64v);
    
    GLPROCLOAD(PFNGLGENQUERIESARBPROC, glGenQueriesARB);
    GLPROCLOAD(PFNGLDELETEQUERIESARBPROC, glDeleteQueriesARB);
    GLPROCLOAD(PFNGLBEGINQUERYARBPROC, glBeginQueryARB);
    GLPROCLOAD(PFNGLENDQUERYARBPROC, glEndQueryARB);
