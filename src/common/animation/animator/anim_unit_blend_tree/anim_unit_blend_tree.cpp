...
bool animBtNodeClip::compile(AnimatorMaster* animator, std::set<animBtNode*>& exec_set, int order) {
...
bool animBtNodeFrame::compile(AnimatorMaster* animator, std::set<animBtNode*>& exec_set, int order) {
    // TODO
    return false;
}

bool animBtNodeBlend2::compile(AnimatorMaster* animator, std::set<animBtNode*>& exec_set, int order) {
