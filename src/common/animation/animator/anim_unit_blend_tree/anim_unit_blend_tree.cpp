...
bool animBtNodeClip::compile(AnimMachine* animator, std::set<animBtNode*>& exec_set, int order) {
...
bool animBtNodeFrame::compile(AnimMachine* animator, std::set<animBtNode*>& exec_set, int order) {
    // TODO
    return false;
}

bool animBtNodeBlend2::compile(AnimMachine* animator, std::set<animBtNode*>& exec_set, int order) {
