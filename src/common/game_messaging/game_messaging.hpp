...
class Actor;
struct PAYLOAD_HIGHLIGHT_ON {
    Actor* sender;
};
struct PAYLOAD_HIGHLIGHT_OFF {
    Actor* sender;
};
...
DEFINE_MSG_PAYLOAD(GAME_MSG::PAWN_CMD, PAYLOAD_PAWN_CMD);
DEFINE_MSG_PAYLOAD(GAME_MSG::HIGHLIGHT_ON, PAYLOAD_HIGHLIGHT_ON);
DEFINE_MSG_PAYLOAD(GAME_MSG::HIGHLIGHT_OFF, PAYLOAD_HIGHLIGHT_OFF);
