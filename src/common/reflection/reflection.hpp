...
public:
    ...
    type_register<T>& prop(const char* name, MEMBER_T T::*member) {
        ...
        prop_desc.fn_setter = [member](void* object, void* value) {
            //((T*)object)->*member = *(MEMBER_T*)value;
        };
        prop_desc.fn_getter = [member](void* object, void* out) {
            //(*(MEMBER_T*)out) = ((T*)object)->*member;
        };
    ...
    type_register<T>& prop(const char* name, GETTER_T(T::*getter)(), void (T::*setter)(SETTER_T)) {
        ...
        prop_desc.fn_setter = [setter](void* object, void* value) {
            (((T*)object)->*setter)(*(base_type<GETTER_T>*)value);
        };
        prop_desc.fn_getter = [getter](void* object, void* out) {
            (*(base_type<GETTER_T>*)out) = (((T*)object)->*getter)();
        };
    ...
    template<typename GETTER_T, typename SETTER_T>
    type_register<T>& prop(const char* name, GETTER_T(T::*getter)() const, void (T::*setter)(SETTER_T)) {
        static_assert(std::is_same < base_type<GETTER_T>, base_type<SETTER_T>>::value, "property setter and getter types must be the same");
        type_property_desc prop_desc;
        prop_desc.name = name;
        prop_desc.t = type_get<base_type<GETTER_T>>();
...
inline void type_foo() {
    ...
    MyClass sub_a;
    sub_a.vector.push_back(MyClass());
    my_obj.vector.push_back(sub_a);
    my_obj.vector.push_back(MyClass());
    nlohmann::json j;
