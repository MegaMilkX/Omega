#include "environment_ssr_pass.hpp"

#include "gpu/common_resources.hpp"


EnvironmentSSRPass::EnvironmentSSRPass() {
    setColorTarget("Lightness", "Final");
    ...
    prog_env_ibl = addShader(resGet<gpuShaderProgram>("shaders/postprocess/environment_ssr.glsl"));
