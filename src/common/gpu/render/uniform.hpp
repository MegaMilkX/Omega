...
constexpr char* UNIFORM_VIEW_TRANSFORM = "matView";
constexpr char* UNIFORM_PROJECTION = "matProjection";
constexpr char* UNIFORM_TIME = "fTime";
constexpr char* UNIFORM_TEXT_LOOKUP_TEXTURE_WIDTH = "lookupTextureWidth";