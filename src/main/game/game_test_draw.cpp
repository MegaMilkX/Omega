...
void TestGame::draw(float dt) {
    ...
    if(0) {
        ...
        const gfxm::vec3 position = gfxm::vec3(-13, 0, 10);
        gfxm::vec3 a = gfxm::vec3(cosf(t) * radius, 2.f, sinf(t) * radius);
        gfxm::vec3 b = gfxm::vec3(cosf(t + gfxm::pi) * radius, 2.f, sinf(t + gfxm::pi) * radius);
